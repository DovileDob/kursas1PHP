<footer>
    <div class="footer-content">
        <div class="footer-section main-logo-left">
            <img id="footer-logo" src="https://www.mediaskopas.lt/wp-content/uploads/2017/08/Mediaskopas-Ziniasklaidos-tyrimai.png" alt="Mediaskopas">
        </div>
    ...
    <div class="info">
        <p class="copyright">&copy; <?php echo date('Y'); ?> Visos teisės mano.</p>
    </div>
</footer>
